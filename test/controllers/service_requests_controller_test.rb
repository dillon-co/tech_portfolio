...
class ServiceRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create service_request" do
    assert_difference('ServiceRequest.count') do
      post service_requests_url, params: { service_request: { client_id: @service_request.client_id, description: @service_request.description, project_type: @service_request.project_type, title: @service_request.title } }
    end
  ...
  test "should update service_request" do
    patch service_request_url(@service_request), params: { service_request: { client_id: @service_request.client_id, description: @service_request.description, project_type: @service_request.project_type, title: @service_request.title } }
